...
def main(year: int, input: str, output: str):
    ...
    path = Path(input)
    files = path.glob(f"e5.oper.an.sfc.*_*.ll025sc.{year}*.nc")
    ...
    # save to file
    output_file = f"e5.oper.an.sfc.sp.1x1.{year}.nc"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/home/ljg48/palmer_scratch/data/ERA5_sp/processed/",
    )
    parser.add_argument(
        "--input",
        help="path to raw data",
        default="/home/ljg48/palmer_scratch/data/ERA5_sp/raw",
    )
