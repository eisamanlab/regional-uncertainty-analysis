...
def main(data_dir: str, output_file: str, start_year: int, end_year: int):
    ...
    for file in path.glob("GCB-2023_OceanModel_*.nc"):
        ...
        _ds = (
            ...
            .to_dataset()
            .assign_coords(model=model_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/home/ljg48/project/data/GCB2023/processed/GCB23_merged.nc",
    )
    ...
    parser.add_argument(
        "--log-file", help="path to log file", default="./process-gcb-2023-models.log"
    )
