""" 
process a single year of ostia data
...
def main(year: int, input: str, output: str):
    ...
    ds = xr.open_mfdataset([file for file in files])[['analysed_sst', 'analysis_error', 'sea_ice_fraction']]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/home/ljg48/palmer_scratch/ostia/processed/",
    )
    parser.add_argument(
        "--input",
        help="path to raw data",
        default="/home/ljg48/palmer_scratch/ostia/raw",
    )
