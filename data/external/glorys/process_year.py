""" 
process a single year of glorys
...
def main(year: int, input: str, output: str):
    ...
    path = Path(input)
    files = path.glob(f"*cmems_mod_glo_phy_*_0.083deg_P1M-m-{year}.nc")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/home/ljg48/palmer_scratch/glorys/processed/",
    )
    parser.add_argument(
        "--input",
        help="path to raw data",
        default="/home/ljg48/palmer_scratch/glorys/raw",
    )
