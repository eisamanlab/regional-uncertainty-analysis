...
def main():
    ...
    output_file = output_path / "salinity-1x1-1993-2022.nc"

    # individual data files paths
    fl_en4 = input_path / "en4-1x1-1993-2022.nc"
    fl_oras5 = input_path / "oras5-1x1-1993-2022.nc"
    fl_glorys = input_path / "glorys-1x1-1993-2022.nc"
    
    list_of_files = [fl_en4, fl_oras5, fl_glorys]
    ...
    ds = xr.merge(list_of_ds)[["salinity"]]
